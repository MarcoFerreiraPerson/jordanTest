...
from kivy.metrics import sp  # import for responsive text size
import random
...
class MyApp(App):
    def build(self):
        ...
        self.name_spinner = Spinner(
            values=['GPT', 'Angelina', 'Bill', 'Annie', 'Add Topic'],
            text='GPT',
            size_hint=(1, 0.09),
            font_size=sp(38),  # Using sp for responsive text
        ...
        self.lbl = Label(text='', halign='center', font_size=sp(25), size_hint_y=None, height=50,
        ...
        self.my_input = TextInput(hint_text='Enter your message...', multiline=True, size_hint=(0.8, 1.2),
                                  font_size=sp(40), background_color=(65 / 255, 76 / 255, 80 / 255))
